						...
						<form role="form" action="<?php  echo site_url()?>/admin/theme/edittheme/<?php echo $filepath; ?>" method="post">
							<div class="row">
								...
								<div class="col-sm-2">
										...
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer">_footer.jsp</a></p>														
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_header">_header.jsp</a></p>															
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer">_search.jsp</a></p>														
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer">_sidebarleft.jsp</a></p>								
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer">aboutus.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">bizconsulting.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">employerrequest.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">hrconsulting.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">hrrecruitment.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">jobsingle.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">singlepost.jsp</a></p>
										<p><a href="<?php  echo site_url()?>/admin/theme/showfile/_footer.php">teamdetail.jsp</a></p>
