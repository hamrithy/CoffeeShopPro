...
<%@ page import="java.util.ArrayList, model.dto.User"%>    
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<%for(int i=0; i<users.size(); i++){ %>
								<tr>
									...
									<td>
										<button style="margin-right:3px" onclick="deletedata('deleteuser.act?userid=<%= users.get(i).getUserid() %>')" class="btn btn-danger">Delete</button>
										<button onclick="window.location.href='getuserupdate.act?userid=<%= users.get(i).getUserid() %>'" class="btn btn-primary">Update</button>
									</td>
								</tr>
							<%} %>
							</tbody>
		...
		function deletedata(url){
			if (confirm("Are you sure you want to delete?") == true) {
				$.get(url ,function(data){
					window.location.href="listusers.act";
				});
			} 
		}
