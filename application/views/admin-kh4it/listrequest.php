...
<%@ page import="java.util.ArrayList, model.dto.Request" %>  
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
		...
		<title>List Jobs | The Looking</title>
					...
					<div class="the-box">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<%for(int i=0; i<requests.size(); i++){ %>
								<tr>
									<td>REQ <%= requests.get(i).getRequestid() %></td>
									<td><%= requests.get(i).getCompanyname() %></td>
									<td><%= requests.get(i).getPosition() %></td>
									<td><%= requests.get(i).getContactperson() %></td>
									<td><%= requests.get(i).getPhonenumber() %></td>
									<td><%= requests.get(i).getEmail() %></td>
									<td>
										<button onclick="window.location.href='viewrequest.act?requestid=<%= requests.get(i).getRequestid() %>'" class="btn btn-info">View File</button>
									</td>
								</tr>
							<% } %>
							</tbody>
