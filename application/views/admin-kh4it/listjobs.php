...
<%
	...
	if(request.getAttribute("jobs")!=null){
		jobs = (ArrayList) request.getAttribute("jobs");
	}else{
					...
					<div class="the-box">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<%for(int i=0; i<jobs.size(); i++){ %>
								<tr>
									<td>TLJ<%=jobs.get(i).getJobid() %></td>
									<td><%=jobs.get(i).getPosition() %></td>
									<td><%=jobs.get(i).getCompany() %></td>
									<td><%=jobs.get(i).getIssuedate() %></td>
									<td><%=jobs.get(i).getExpireddate() %></td>
									<td>
