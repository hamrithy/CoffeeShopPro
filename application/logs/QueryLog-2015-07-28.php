...
SELECT *, (SELECT COUNT(A.foodid) FROM FOODS A WHERE A.foodtypeid=B.foodtypeid) AS TOTL FROM FOODTYPES B ORDER BY B.title 
 Execution Time:0.26730298995972

SELECT `A`.`foodid`, `A`.`title` As `food_title`, `A`.`description` As `food_description`, `A`.`foodtypeid`, `A`.`thumbnailurl`, `A`.`promotiontype`, `A`.`price`, `A`.`userid`, `B`.`title` As `foodtype_title`, `B`.`description` As `footype_description`
FROM `FOODS` `A`
JOIN `FOODTYPES` `B` ON `A`.`foodtypeid`=`B`.`foodtypeid` 
 Execution Time:0.26203203201294
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25788593292236

SELECT `s`.`slideid`, `s`.`title`, `s`.`caption`, `s`.`linkto`, `s`.`imageurl`, `s`.`ordering`, `u`.`userid`, `u`.`username`
FROM `SLIDES` `s`
JOIN `USERS` `u` ON `s`.`userid` = `u`.`userid`
ORDER BY `s`.`ordering` DESC 
 Execution Time:0.23972296714783

SELECT `s`.`serviceid`, `s`.`title`, `s`.`description`, `s`.`linkto`, `s`.`imageurl`, `s`.`ordering`
FROM `SERVICES` `s`
ORDER BY `s`.`ordering` DESC 
 Execution Time:0.26537013053894
...
ORDER BY `A`.`foodid` DESC
 LIMIT 1 
 Execution Time:0.25386810302734
...
ORDER BY `A`.`foodid` DESC
 LIMIT 1 
 Execution Time:0.24960613250732

SELECT *
FROM `FOODTYPES`
ORDER BY `title` ASC 
 Execution Time:0.25819897651672

SELECT `A`.`foodid`, `A`.`title` As `food_title`, `A`.`description` As `food_description`, `A`.`foodtypeid`, `A`.`thumbnailurl`, `A`.`promotiontype`, `A`.`price`, `A`.`userid`, `B`.`title` As `foodtype_title`, `B`.`description` As `footype_description`
FROM `FOODS` `A`
JOIN `FOODTYPES` `B` ON `A`.`foodtypeid`=`B`.`foodtypeid` 
 Execution Time:0.25559186935425
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25238108634949
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24197793006897
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24970006942749
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25553894042969

SELECT *
FROM `FOODTYPES`
ORDER BY `title` ASC 
 Execution Time:0.24605417251587

SELECT `A`.`foodid`, `A`.`title` As `food_title`, `A`.`description` As `food_description`, `A`.`foodtypeid`, `A`.`thumbnailurl`, `A`.`promotiontype`, `A`.`price`, `A`.`userid`, `B`.`title` As `foodtype_title`, `B`.`description` As `footype_description`
FROM `FOODS` `A`
JOIN `FOODTYPES` `B` ON `A`.`foodtypeid`=`B`.`foodtypeid` 
 Execution Time:0.25018286705017
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25128102302551
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.23782205581665
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.2633810043335
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.23634219169617
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25171899795532
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24861693382263
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.27030181884766
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.2455530166626
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24248600006104
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.29390788078308
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.29173684120178
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.2676408290863
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.29406905174255
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24005484580994
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26140308380127
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26935887336731
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25395703315735
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24776005744934
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24536800384521
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24433588981628
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.23669600486755
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24295282363892
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24039888381958
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25443696975708
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24566984176636
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25028610229492
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.23123407363892
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26987886428833
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.23743391036987
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26305794715881
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26552796363831
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.24838399887085
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26003909111023

SELECT *, (SELECT COUNT(A.foodid) FROM FOODS A WHERE A.foodtypeid=B.foodtypeid) AS TOTL FROM FOODTYPES B ORDER BY B.title 
 Execution Time:0.24064207077026

SELECT `A`.`foodid`, `A`.`title` As `food_title`, `A`.`description` As `food_description`, `A`.`foodtypeid`, `A`.`thumbnailurl`, `A`.`promotiontype`, `A`.`price`, `A`.`userid`, `B`.`title` As `foodtype_title`, `B`.`description` As `footype_description`
FROM `FOODS` `A`
JOIN `FOODTYPES` `B` ON `A`.`foodtypeid`=`B`.`foodtypeid` 
 Execution Time:0.24650382995605
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.23982691764832

SELECT `s`.`serviceid`, `s`.`title`, `s`.`description`, `s`.`linkto`, `s`.`imageurl`, `s`.`ordering`
FROM `SERVICES` `s`
ORDER BY `s`.`ordering` DESC 
 Execution Time:0.25887107849121
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26411008834839
...
ORDER BY `A`.`foodid` DESC
 LIMIT 1 
 Execution Time:0.26094603538513

SELECT `s`.`slideid`, `s`.`title`, `s`.`caption`, `s`.`linkto`, `s`.`imageurl`, `s`.`ordering`, `u`.`userid`, `u`.`username`
FROM `SLIDES` `s`
JOIN `USERS` `u` ON `s`.`userid` = `u`.`userid`
ORDER BY `s`.`ordering` DESC 
 Execution Time:0.26879000663757
...
ORDER BY `A`.`foodid` DESC
 LIMIT 1 
 Execution Time:0.26672387123108

SELECT *
FROM `FOODTYPES`
ORDER BY `title` ASC 
 Execution Time:0.252032995224

SELECT `A`.`foodid`, `A`.`title` As `food_title`, `A`.`description` As `food_description`, `A`.`foodtypeid`, `A`.`thumbnailurl`, `A`.`promotiontype`, `A`.`price`, `A`.`userid`, `B`.`title` As `foodtype_title`, `B`.`description` As `footype_description`
FROM `FOODS` `A`
JOIN `FOODTYPES` `B` ON `A`.`foodtypeid`=`B`.`foodtypeid` 
 Execution Time:0.25668692588806
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.25508499145508
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.27984809875488

SELECT *, (SELECT COUNT(A.foodid) FROM FOODS A WHERE A.foodtypeid=B.foodtypeid) AS TOTL FROM FOODTYPES B ORDER BY B.title 
 Execution Time:0.26467609405518

SELECT `A`.`foodid`, `A`.`title` As `food_title`, `A`.`description` As `food_description`, `A`.`foodtypeid`, `A`.`thumbnailurl`, `A`.`promotiontype`, `A`.`price`, `A`.`userid`, `B`.`title` As `foodtype_title`, `B`.`description` As `footype_description`
FROM `FOODS` `A`
JOIN `FOODTYPES` `B` ON `A`.`foodtypeid`=`B`.`foodtypeid` 
 Execution Time:0.26795101165771
...
SELECT DISTINCT(A.menuid),A.title, A.linkto, A.ordering, A.subof, A.status,(CASE WHEN B.menuid IS NOT NULL THEN 1 ELSE 0 END) AS parent 
				...
				ON A.menuid = B.subof
				ORDER BY A.subof,A.ordering 
 Execution Time:0.26613020896912
...
ORDER BY `A`.`foodid` DESC
 LIMIT 1 
 Execution Time:0.23461484909058
...
ORDER BY `A`.`foodid` DESC
 LIMIT 1 
 Execution Time:0.2531840801239

SELECT `s`.`slideid`, `s`.`title`, `s`.`caption`, `s`.`linkto`, `s`.`imageurl`, `s`.`ordering`, `u`.`userid`, `u`.`username`
FROM `SLIDES` `s`
JOIN `USERS` `u` ON `s`.`userid` = `u`.`userid`
ORDER BY `s`.`ordering` DESC 
 Execution Time:0.26152086257935

SELECT `s`.`serviceid`, `s`.`title`, `s`.`description`, `s`.`linkto`, `s`.`imageurl`, `s`.`ordering`
FROM `SERVICES` `s`
ORDER BY `s`.`ordering` DESC 
 Execution Time:0.26293587684631
